"""Modulo per descrivere le funzioni base per EV, probabilità, valore e simulazione."""
...
def expected_value(prob: float, odds: float, stake: float = 1.0) -> float:
    ...
    Formula: EV = prob * (odds * stake) - (1 - prob) * stake
    """
...
def simulate(match_id: str, providers: list, n: int = 1000) -> dict:
    """
    Simulazione Monte Carlo mock. Restituisce una distribuzione fittizia.
    """
